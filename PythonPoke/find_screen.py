...
def main():
    """Znajduje ekran, nasępnie go prostuje z pomocą kalibracji i wyznacza jego krawędzie."""
    # construct the argument parser and parse the arguments
    _ap = argparse.ArgumentParser()
    _ap.add_argument("-q", "--query", required=True,
                     help="Path to the query image")
    args = vars(_ap.parse_args())
    ...
    (h, w) = warp.shape
    (dX, dY) = (int(w * 0.35), int(h * 0.40))
    crop = warp[5:dY, w - dX:w - 5]
